  ...
  return (
    <div className="container py-4 py-lg-5">
      <header className="d-flex justify-content-between align-items-start gap-3 mb-4">
        ...
        <button type="button" className="btn btn-primary flex-shrink-0" onClick={() => setShowForm(true)}>
      ...
      {posts.length === 0 ? (
        <div className="empty-state">
          <i className="bi bi-chat-square-heart fs-1 text-primary" aria-hidden="true"></i>
