  ...
  return (
    <div className="container py-4 py-lg-5">
      <header className="mb-4">
        ...
        <p className="text-muted mb-0">Formosa Capital · Juntos prevenimos el dengue</p>
      </header>
          ...
          {diseaseInfo.map((disease) => (
            <button
              ...
              className={`btn btn-sm rounded-pill ${
                activeDisease === disease.id ? 'text-white' : 'btn-outline-secondary'
              }`}
              style={activeDisease === disease.id ? { backgroundColor: disease.color, borderColor: disease.color } : undefined}
    ...
    <div className="col-12 col-md-4">
      <Link to={to} className="text-decoration-none">
        <div className="card h-100 shadow-sm">
          <div className="card-body">
            <i className={`bi ${icon} text-primary fs-2 mb-2 d-block`} aria-hidden="true"></i>
