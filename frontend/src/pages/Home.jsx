        ...
        <div className="row g-4 align-items-center">
          <div className="col-12 col-lg-5">
            ...
            <p className="text-muted mb-4">
              Participá en foros locales, presentá reportes y completá tareas cívicas para ganar puntos y
              participar en sorteos de premios grandes.
            </p>
...
function FormosaMapIllustration() {
  return (
    <svg viewBox="0 0 220 220" width="100%" height="220" role="img" aria-label="Mapa ilustrativo de la provincia de Formosa">
      <path
...
function GamifiedPanel({ auth }) {
  if (!auth.isAuthenticated) {
    return (
      <div className="glass-panel-strong rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-center">
        <i className="bi bi-award fs-1 text-primary mb-2" aria-hidden="true"></i>
        <p className="small fw-semibold mb-0">Iniciá sesión para ver tu progreso y tus puntos.</p>
      </div>
    )
  }
  ...
  return (
    <div className="glass-panel-strong rounded-4 p-4 h-100">
      ...
      <p className="small text-muted mt-2 mb-0">Sumá puntos completando reportes y tareas cívicas.</p>
    </div>
  )
}
