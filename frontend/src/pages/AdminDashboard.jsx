  ...
  return (
    <div className="container py-4 py-lg-5">
      <header className="mb-4">
        ...
        <p className="text-muted mb-0">Gestión de reportes, avisos territoriales y moderación del foro</p>
      </header>
        ...
        <section className="col-12 col-lg-6" aria-labelledby="reports-heading">
          ...
          {reports.length === 0 ? (
            ...
            <div className="d-flex flex-column gap-3">
              {reports.map((report) => (
                <ReportCard key={report.id} report={report} onChangeStatus={setReportStatus} />
              ))}
            </div>
          )}
        </section>
        ...
        <section className="col-12 col-lg-6" aria-labelledby="schedule-heading">
          ...
          {posts.length === 0 ? (
            ...
            <ul className="list-group">
              {posts.map((post) => (
                <li key={post.id} className="list-group-item bg-transparent d-flex justify-content-between align-items-center gap-2">
