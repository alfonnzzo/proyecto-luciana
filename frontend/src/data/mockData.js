...
export const diseaseInfo = [
  {
    ...
    sintomaDistintivo: 'Dolor retroocular y muscular intenso ("fiebre quebrantahuesos")',
    queEs:
  ...
  },
  {
    ...
    sintomaDistintivo: 'Dolor articular severo e incapacitante, bilateral y simétrico',
    queEs:
    ...
    sintomas: [
      ...
      {
        titulo: 'Fase crónica',
        items: ['En un porcentaje significativo de pacientes, los dolores articulares pueden persistir durante meses o años.'],
      },
    ],
    prevencion: [
  ...
  },
  {
    ...
    sintomaDistintivo: 'Paroxismo palúdico (escalofríos, fiebre y sudoración cíclicos)',
    queEs:
    ...
    sintomas: [
      ...
      },
      {
        ...
        items: ['Si no se trata, P. falciparum puede causar insuficiencia renal, convulsiones, coma (malaria cerebral) y la muerte.'],
      },
    ],
    prevencion: [
