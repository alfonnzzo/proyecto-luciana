...
export const diseaseInfo = [
  {
    ...
    sintomas: ['Fiebre alta súbita', 'Dolor detrás de los ojos', 'Dolor muscular y articular', 'Manchas en la piel'],
  },
  {
    id: 'zika',
    nombre: 'Zika',
    ...
    descripcion: 'Transmitido por el mismo mosquito que el dengue, suele ser más leve pero riesgoso en el embarazo.',
    sintomas: ['Erupción en la piel', 'Fiebre leve', 'Conjuntivitis', 'Dolor en articulaciones'],
  },
  {
    id: 'chikungunya',
    nombre: 'Chikungunya',
    color: '#f0ad4e',
    icono: 'bi-bandaid',
    descripcion: 'Provoca fuertes dolores articulares que pueden persistir por semanas o meses.',
    sintomas: ['Fiebre elevada', 'Dolor articular intenso', 'Hinchazón en articulaciones', 'Dolor de cabeza'],
  },
  {
    id: 'malaria',
    nombre: 'Malaria',
    ...
    descripcion: 'Causada por un parásito transmitido por el mosquito Anopheles, requiere atención médica urgente.',
    sintomas: ['Escalofríos', 'Fiebre cíclica', 'Sudoración intensa', 'Fatiga extrema'],
  },
]
...
export const weatherAlert = {
  ...
  horaLluvia: '18:00 hs',
  recomendacion: 'Revisá tu patio: dá vuelta baldes, macetas y neumáticos antes de que llueva.',
  nivelRiesgo: 'alto',
}
...
export const challengeTasks = [
  ...
  },
  {
    ...
    descripcion: 'Cubrí tanques y aljibes para impedir el ingreso de mosquitos.',
    estado: 'sin_enviar',
    foto: null,
  },
]
...
export const municipalEvents = [
  {
    ...
    recomendaciones: 'Cerrar ventanas y puertas. Retirar ropa colgada y cubrir recipientes de agua y comida.',
  },
  {
    id: 2,
    ...
    recomendaciones: 'Sacar a la vereda objetos en desuso que puedan acumular agua (cubiertas, botellas, latas).',
  },
  {
    id: 3,
    actividad: 'Fumigación',
    ...
    recomendaciones: 'Mantener a mascotas dentro del hogar durante la fumigación.',
  },
  {
    id: 4,
    actividad: 'Descacharreo',
    ...
    recomendaciones: 'Separar los residuos reciclables de los objetos que serán retirados por la cuadrilla.',
  },
]
