...
const adminLinks = [{ to: '/admin', label: 'Panel Admin', icon: 'bi-clipboard-check' }]
...
function AppNavbar({ role, onRoleChange }) {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg sticky-top" style={{ background: 'var(--color-primary)' }}>
...
function RoleSwitch({ role, onRoleChange, compact }) {
  return (
    <div className="btn-group role-switch" role="group" aria-label="Selector de rol">
      <button
        type="button"
